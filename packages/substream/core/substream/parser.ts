...
export const SpacePluginCreatedEvent = Schema.Struct({
  spacesCreated: Schema.Array(
    Schema.Struct({
      daoAddress: Schema.String,
      spaceAddress: Schema.String,
    })
  ),
});

export type SpacePluginCreatedEvent = typeof SpacePluginCreatedEvent.Type;

export const EditPublishedEvent = Schema.Struct({
  editsPublished: Schema.Array(
    Schema.Struct({
      contentUri: Schema.String,
      pluginAddress: Schema.String,
      daoAddress: Schema.String,
    })
  ),
});

export type EditPublishedEvent = typeof EditPublishedEvent.Type;
