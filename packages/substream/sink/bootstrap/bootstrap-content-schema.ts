import { CONTENT_IDS, Relation, SYSTEM_IDS } from '@geogenesis/sdk';

import type { CreateRelationOp, Op } from '../types';
...
const names: Record<string, string> = {
  ...
  [CONTENT_IDS.COVER_ATTRIBUTE]: 'Cover',
  ...
  [CONTENT_IDS.RELATED_PEOPLE_ATTRIBUTE]: 'Related reople',
  [CONTENT_IDS.ROLE_ATTRIBUTE]: 'Role',
  [CONTENT_IDS.HIGHLIGHTED_RELATIONS_ATTRIBUTE]: 'Highlighted relations',
  ...
  [CONTENT_IDS.SUPPORTING_CLAIMS_ATTRIBUTE]: 'Supporting claims',
  [CONTENT_IDS.OPPOSING_CLAIMS_ATTRIBUTE]: 'Opposing claims',
...
const attributes: Record<string, string> = {
  ...
  [CONTENT_IDS.COVER_ATTRIBUTE]: SYSTEM_IDS.IMAGE,
  ...
  [CONTENT_IDS.ROLE_ATTRIBUTE]: SYSTEM_IDS.RELATION,
  [CONTENT_IDS.HIGHLIGHTED_RELATIONS_ATTRIBUTE]: SYSTEM_IDS.RELATION,
  ...
  [CONTENT_IDS.SUPPORTING_CLAIMS_ATTRIBUTE]: SYSTEM_IDS.RELATION,
  [CONTENT_IDS.OPPOSING_CLAIMS_ATTRIBUTE]: SYSTEM_IDS.RELATION,
