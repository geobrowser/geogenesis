...
import { mapTriplesWithActionType } from './map-triples';
...
describe('mapTriplesWithActionType', () => {
  it('creates expected triples data from actions', () => {
    const actions = 'data from some IPFS file';
     ...
     * SUBSPACE proposal
     */
    const idk = mapTriplesWithActionType([], 0, 0);
  });
});
