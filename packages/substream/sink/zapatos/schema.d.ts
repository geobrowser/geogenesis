...
declare module 'zapatos/schema' {
  ...
  export namespace triple_versions {
    ...
    export interface Selectable {
      /**
      * **triple_versions.space_id**
      * - `text` in database
      * - `NOT NULL`, no default
      */
      space_id: string;
      /**
      * **triple_versions.entity_id**
      * - `text` in database
      * - `NOT NULL`, no default
      */
      entity_id: string;
      /**
      * **triple_versions.attribute_id**
      * - `text` in database
      * - `NOT NULL`, no default
      */
      attribute_id: string;
