...
export class StringValue extends Value {
  ...
  static fromJSON(__json: JSON.Value): StringValue | null {
    if (!__json.isObj) {
      log.debug('StringValue.fromJSON(): __json.isObj is false', [])
      return null
    }
    ...
    if (__type == null) {
      log.debug('StringValue.fromJSON(): __type is null', [])
      return null
    }
    ...
    if (__id == null) {
      log.debug('StringValue.fromJSON(): __id is null', [])
      return null
    }
    ...
    if (__value == null) {
      log.debug('StringValue.fromJSON(): __value is null', [])
      return null
    }
    const value = __value.valueOf()

    return new StringValue(id, value)
  }
}
