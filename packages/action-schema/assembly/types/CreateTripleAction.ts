...
export class CreateTripleAction extends Action {
  entityId: string
  attributeId: string
  value: Value
  ...
  static fromJSON(__json: JSON.Value): CreateTripleAction | null {
    if (!__json.isObj) {
      log.debug('CreateTripleAction.fromJSON(): __json.isObj is false', [])
      return null
    }
    ...
    if (__type == null) {
      log.debug('CreateTripleAction.fromJSON(): __type is null', [])
      return null
    }
    ...
    if (__entityId == null) {
      log.debug('CreateTripleAction.fromJSON(): __entityId is null', [])
      return null
    }
    ...
    if (__attributeId == null) {
      log.debug('CreateTripleAction.fromJSON(): __attributeId is null', [])
      return null
    }
    ...
    if (__value == null) {
      log.debug('CreateTripleAction.fromJSON(): __value is null', [])
      return null
    }
    ...
    return new CreateTripleAction(entityId, attributeId, value)
  }
}
