import { CreateEntityAction, CreateTripleAction, EntityValue, StringValue } from '@geogenesis/action-schema/assembly'
...
export function bootstrap(space: string, createdAtBlock: BigInt): void {
	...
	handleCreateTripleAction({
		fact: new CreateTripleAction('type', 'name', new StringValue('type', 'Types')),
		space,
		isProtected: false,
		createdAtBlock,
	})
	...
	handleCreateTripleAction({
		fact: new CreateTripleAction('name', 'name', new StringValue('name', 'Name')),
		space,
		isProtected: true,
		createdAtBlock,
	})
	...
	handleCreateTripleAction({
		fact: new CreateTripleAction('attribute', 'name', new StringValue('attribute', 'Attribute')),
		space,
		isProtected: true,
		createdAtBlock,
	})
	...
	handleCreateTripleAction({
		fact: new CreateTripleAction('space', 'name', new StringValue('space', 'Space')),
		space,
		isProtected: true,
		createdAtBlock,
	})
