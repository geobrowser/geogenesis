...
export interface TestMemberAccessExecuteConditionInterface
  extends utils.Interface {
  functions: {
    'decodeAddRemoveMemberCalldata(bytes)': FunctionFragment
  ...
  encodeFunctionData(
    functionFragment: 'decodeAddRemoveMemberCalldata',
...
export interface TestMemberAccessExecuteCondition extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: TestMemberAccessExecuteConditionInterface
  ...
  functions: {
    ...
    ): Promise<[string, string] & { sig: string; account: string }>
