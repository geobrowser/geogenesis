...
function DropdownMenuItem({
	...
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cn(
				"relative flex cursor-default items-center gap-2 outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 transition-colors duration-100",
				className,
			)}
			{...props}
		/>
