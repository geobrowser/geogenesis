...
import { ResultContent, ResultsList } from '~/partials/entity-page/autocomplete/results-list';
import { useAutocomplete } from '~/modules/search';
import { useSpaces } from '~/core/hooks/use-spaces';
import { Text } from '~/design-system/text';
import { ResultItem } from '~/partials/entity-page/autocomplete/results-list';
