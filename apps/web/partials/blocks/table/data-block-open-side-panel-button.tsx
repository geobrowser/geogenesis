...
const sidePanelOpenerClassName =
  'inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-sm border-none bg-transparent p-0 text-grey-03 transition duration-300 ease-in-out hover:text-text focus:outline-hidden';
