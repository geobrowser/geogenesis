...
import { pendingCreatePostSidePanelAtom } from '~/atoms/personal-profile-suggested';
          ...
          <EntityPageContentContainer>
            <div>
              <div className="space-y-2">
                ...
                {!isRelationPage && (
                  <EntityPageInlineDescription entityId={entityId} spaceId={entitySpaceId} />
                )}
...
export function EntitySidePanel() {
  ...
  const pendingCreatePostSidePanel = useAtomValue(pendingCreatePostSidePanelAtom);
  ...
  }, [pathname, pendingCreatePostSidePanel, sidePanelTarget, closeSidePanel]);
