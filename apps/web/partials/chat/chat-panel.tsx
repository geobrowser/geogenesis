...
export function ChatPanel({
  ...
  return (
    <motion.div
      ...
      className={`fixed right-4 ${BOTTOM_INSET_OFFSET_CLASS} z-1100 flex max-h-[calc(100dvh-1rem-var(--app-bottom-inset,0px))] flex-col overflow-hidden rounded-[20px] border border-grey-02 bg-white shadow-[0px_20px_20px_0px_rgba(0,0,0,0.04)]`}
    >
      <ResizeHandle
