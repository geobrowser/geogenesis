...
export const ImportReview = ({ spaceId }: ImportReviewProps) => {
  ...
  useEffect(() => {
    if (values.length === 0 && !isLoading) hasAutoGeneratedRef.current = false;
  ...
  const handleSelectProperty = useCallback(
    ...
    [schema, setColumnMapping, setExtraProperties, setValues, setRelations]
  );
  ...
  const handleCreateProperty = useCallback(
    ...
    [setColumnMapping, setExtraProperties, setValues, setRelations]
  );
