...
export const ImportReview = ({ spaceId }: ImportReviewProps) => {
  ...
  }, [canGenerate, values.length, isLoading, generate]);
  ...
  const handleSelectProperty = useCallback(
    (csvColumnIndex: number, propertyId: string, property: Property) => {
      ...
      // Clear generated values so auto-generate re-fires with updated mapping
      hasAutoGeneratedRef.current = false;
  ...
  const handleResolveRelationToken = useCallback(
    ...
    [clearGeneratedChanges, columnMapping, setRelationOverrides]
  );
  ...
  const handleResolveTypeValue = useCallback(
    ...
    [clearGeneratedChanges, setTypeOverrides]
  );
  ...
  const handleResolveEntityRow = useCallback(
    ...
    [clearGeneratedChanges, setRowOverrides]
  );
