...
describe('ClaimResponseTag', () => {
  ...
  it('says how they come down on an ordinary claim', () => {
    render(<ClaimResponseTag response={{ stance: 'agree' }} forPosition />);

    expect(screen.getByText('agrees')).toBeInTheDocument();
  });

  it('says disagrees for the other side', () => {
    render(<ClaimResponseTag response={{ stance: 'disagree' }} forPosition={false} />);
  ...
  it('says disagrees for the other side of a claim that used to be factual', () => {
    render(<ClaimResponseTag response={{ stance: 'disagree' }} forPosition={false} />);
  ...
  it('appears under the button matching their side, and not the other', () => {
    const { container } = render(<ClaimResponseTag response={{ stance: 'agree' }} forPosition={false} />);

    expect(container).toBeEmptyDOMElement();
  });

  it('puts a disagreement under Disagree rather than Agree', () => {
    const { container } = render(<ClaimResponseTag response={{ stance: 'disagree' }} forPosition />);

    expect(container).toBeEmptyDOMElement();
  });

  it('says nothing for a claim they have not answered', () => {
    const { container } = render(<ClaimResponseTag response={undefined} forPosition />);
  ...
  it('says nothing when they answered "neither"', () => {
    ...
    const { container } = render(<ClaimResponseTag response={{}} forPosition />);
  ...
  it('names the person whose record it is', () => {
    render(<ClaimResponseTag response={{ stance: 'agree' }} personName="Susan Winter" forPosition />);
