...
export async function getActiveProposalDiff(
  ...
  for (const entityId of entityIds) {
    ...
    // at the time that the proposal was created.
    //
    ...
    // at the time the proposal was created. We compare the merged entity with the state of
    // the entity before the proposal was created to determine the changes that the proposal
    // introduces.
    //
