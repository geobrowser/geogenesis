  ...
  inputSchema: jsonSchema<SearchImagesInput>({
    ...
    properties: {
      query: {
        ...
        maxLength: 500,
        description:
          'Focused image-search query — a title or subject plus the media kind (e.g. a poster, cover, or logo).',
      },
    },
    required: ['query'],
