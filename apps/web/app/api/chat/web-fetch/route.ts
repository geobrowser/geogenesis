...
type ParsedUrl = { url: URL; isXPost: boolean; xPath: { user: string; statusId: string } | null };
...
function validateUrl(input: unknown): ParsedUrl | null {
...
type FxTweetMedia = { type?: unknown; url?: unknown };
type FxTweet = {
  id?: unknown;
  url?: unknown;
  text?: unknown;
...
function summarizeFxTweet(tweet: FxTweet, originalUrl: string): { summary: string; sources: Source[] } | null {
