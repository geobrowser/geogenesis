...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  // Metadata is generated by the layout, which renders independently of the page — so the
  // page's Hidden guard (GEO-2809) does not reach it. Without this, a withheld entity's
  // body 404s while its name and description still unfurl in a Slack or Twitter preview,
