    ...
    <div className="fixed inset-0 z-[150] overflow-x-hidden overflow-y-auto bg-white text-text">
      <main className="mx-auto min-h-dvh w-full max-w-[720px] px-5 pt-8 pb-8 sm:px-8">
        ...
        <HubQueryState
          ...
          // Three dead ends, and each has a different way out. Ordered by how much the viewer has
          // to give up: clearing their filters, then dropping the toggle, then leaving the tab.
          emptyAction={
            hasFilters
              ? {
                  label: 'Clear filters',
        ...
        {taggedHasNextPage && !showsSections && tab === 'explore' ? (
