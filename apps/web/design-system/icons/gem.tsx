  ...
  return (
    <span className="h-3 w-3 flex-none [&>svg]:h-full [&>svg]:w-full">
      <svg
        ...
        className="block duration-250 ease-in group-hover:hidden"
      >
        <title>Bounty Filled</title>
      ...
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="hidden duration-250 ease-in group-hover:block"
      >
        <title>Bounty Filled White</title>
