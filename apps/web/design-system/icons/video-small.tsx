...
export function VideoSmall({ color, variant = 'outline', className }: Props) {
  ...
  return (
    <svg width="16" height="16" viewBox={viewBox} className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
