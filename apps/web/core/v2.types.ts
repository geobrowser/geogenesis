...
export type RenderableType = 'IMAGE' | 'URL' | 'GEO_LOCATION' | 'PDF'; // GEO_LOCATION needs to be migrated to SDK
...
export type RenderableEntityType = 'IMAGE' | 'RELATION' | 'DATA' | 'TEXT' | 'POINT' | 'PDF';
