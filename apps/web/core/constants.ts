...
export const DEFAULT_GEO_SPACE_PLUGIN_ADDRESS = '';
export const DEFAULT_GEO_SPACE_PLUGIN_REPO_ADDRESS = '';
export const DEFAULT_GEO_MEMBER_ACCESS_PLUGIN_ADDRESS = '';
export const DEFAULT_GEO_MEMBER_ACCESS_PLUGIN_REPO_ADDRESS = '';
export const DEFAULT_GEO_MAIN_VOTING_PLUGIN_ADDRESS = '';
export const DEFAULT_GEO_MAIN_VOTING_PLUGIN_REPO_ADDRESS = '';
export const DEFAULT_GEO_PERSONAL_SPACE_PLUGIN_ADDRESS = '';
export const DEFAULT_GEO_PERSONAL_SPACE_PLUGIN_REPO_ADDRESS = '';
