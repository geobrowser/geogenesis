...
export async function fetchTableRowEntitiesWithCount(
  options: FetchTableRowEntitiesOptions
  ...
  const resultEntities = entities.nodes
    .map(e => {
